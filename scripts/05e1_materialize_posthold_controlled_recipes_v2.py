...
SCRIPT_VERSION = "05e1-materialize-posthold-controlled-recipes-v2-summary-keyfix-no-cli"
...
def main() -> None:
    ...
    print("  Technical recovery from 05e1 v1 summary-key lookup bug: YES")
    ...
    summary = {
        ...
        "05e0_contract_sha256": observed_contract_hash,
        "technical_recovery": {
            "prior_failed_script_version": "05e1-materialize-posthold-controlled-recipes-v1-no-cli",
            "failure_stage": "pre-materialization 05e0 summary artifact-hash key lookup",
            "scientific_contract_changed": False,
            "recipes_created_before_prior_failure": False,
            "fix": (
                "Read compact 05e0 summary artifact_hashes keys: "
                "contract/scenario_registry/model_registry/contrast_registry."
            ),
        },

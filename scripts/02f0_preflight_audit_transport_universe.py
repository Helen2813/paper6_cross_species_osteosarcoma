...
SCRIPT_VERSION = "02f0-preflight-audit-transport-universe-v1-no-cli"
...
OUT_DIR = ROOT / "results" / "transport_contract" / "02f0_preflight_audit"
...
def main() -> None:
    ...
    all_lineage_tokens_present = bool(source_lineage["token_present"].all())
    ...
    checks = {
        ...
        "source_code_lineage_tokens_all_present": all_lineage_tokens_present,
    ...
    critical_checks = [
        ...
        "source_code_lineage_tokens_all_present",
        "outcome_aware_master_header_markers_present",
    ]
    ...
    audit = {
        ...
        "source_lineage_all_tokens_present": all_lineage_tokens_present,
        "source_files": {
    ...
    print(
        "  all expected outcome/model-input and lineage tokens present: "
        f"{all_lineage_tokens_present}"
    )
    print(f"  outcome-aware master header markers found: {len(outcome_aware_header_cols)}")

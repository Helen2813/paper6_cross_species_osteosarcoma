...
SCRIPT_VERSION = (
    "05f3-open-reserved-target-os-and-run-frozen-evaluation-v1-no-cli"
)
EXECUTION_VERSION = (
    "paper6-first-reserved-target-os-frozen-execution-v1"
)
...
# 05f3 outputs.
# ---------------------------------------------------------------------------
OUT_DIR = ROOT / "results" / "human_posthold_descriptive" / "05f3"
...
def main() -> None:
    ...
    print("=" * 120)
    print("Paper 6 - FIRST reserved TARGET-OS outcome opening and frozen execution")
    print("=" * 120)
    ...
    if not np.array_equal(
        ...
        raise RuntimeError(
            "TARGET NPZ sample order differs from frozen 05f1c mapping."
        )
    ...
    print("=" * 120)
    print(
        "05f3: PASS_FIRST_RESERVED_TARGET_OS_FROZEN_DESCRIPTIVE_EVALUATION_COMPLETE"
    )
    print("=" * 120)
